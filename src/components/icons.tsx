...
export const ArrowLeftIcon: SvgIcon = makeIcon(<path d="M19 12H5M12 19l-7-7 7-7" />);
...
export const ZapIcon: SvgIcon = makeIcon(<path d="M13 2 3 14h9l-1 8 10-12h-9l1-8z" />);
