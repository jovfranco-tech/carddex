    ...
    <>
      <div
        ...
        style={{
          ...
          width: 'calc(100% - 32px)',
          maxWidth: 360,
          background: 'linear-gradient(135deg, rgba(123,90,217,0.92) 0%, rgba(47,111,224,0.92) 100%)',
      ...
      >
            ...
            {[...Array(8)].map((_, i) => (
              <div
                ...
                style={{
                  ...
                  height: 5,
                  borderRadius: '50%',
                  background: ['#FFD700', '#FF6B6B', '#4ECDC4', '#FFE66D', '#A8E063', '#F7797D', '#FFECD2', '#C3E88D'][i],
                  left: `${10 + i * 12}%`,
                  top: '50%',
        ...
        <div
          style={{
            ...
            flexShrink: 0,
            animation: visible ? 'bounceEmoji 0.6s cubic-bezier(0.34, 1.56, 0.64, 1) 200ms both' : undefined,
          }}
        >
          {achievement?.emoji}
        </div>
